...
libraryDependencies += "org.hibernate" % "hibernate-entitymanager" % "5.2.4.Final"

libraryDependencies += "org.springframework" % "spring-context" % "4.3.3.RELEASE"

libraryDependencies += "org.springframework" % "spring-web" % "4.3.3.RELEASE"

libraryDependencies += "org.springframework" % "spring-aop" % "4.3.3.RELEASE"
